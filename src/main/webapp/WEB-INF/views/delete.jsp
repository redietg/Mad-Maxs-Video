...
<tr>
<td><img src="<c:url value="/images/${ movie.title}.jpg"></c:url>"/></td>
 <td>
     id =   ${movie.id}
 Title :
...
<spring:url value="/delete"  var="movieId" >
   				<spring:param name="id" value="${movie.id}" />
   				
   				
 		</spring:url>
</td>
 <td>Total cost :$ ${movie.rentalPrice } <br /><a href="${movieId}">Delete</a></td>
</tr>
</c:forEach>
</table>
 </div>
